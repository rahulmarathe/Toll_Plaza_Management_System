        ...
        <div class="container">
            <div class="row">
             		<div class="col-md-8 col-sm-12">
                        <h2 class="head-title">View Manager Page</h2>
                        <hr class="botm-line">
            			<h2>Welcome...</h2>

   						<table class="table table-bordered table-responsive table-hover table-striped" width="70%" cellpadding="2"> 
	                	<thead>
	                		<tr><th>Manager Id</th><th>Password</th><th>Email</th><th>Contact</th><th>Toll Id</th><th>Info Id</th><th>Edit</th><th>Delete</th></tr>
	                	</thead>
	                	<tbody>
						   ...
						   <tr>  
							   ...
							   <td>${emp.tollid}</td>
							   <td>${emp.infoid}</td>
							   <td><a href="editman/${emp.managerid}">Edit</a></td>
							   <td><a href="deleteman/${emp.managerid}">Delete</a></td>							     
						   </tr>  
						   </c:forEach>  	
	                	</tbody>
	   				</table>
