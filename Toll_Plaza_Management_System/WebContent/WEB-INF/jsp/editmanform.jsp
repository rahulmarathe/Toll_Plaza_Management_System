        ...
        <div class="container">
            <div class="row">
             		<div class="col-md-8 col-sm-12">
                        <h2 class="head-title">Edit Manager Page</h2>
                        <hr class="botm-line">
                        
						<form:form class="form-horizontal" role="form" action="/SimpleProjectLogin/editsaveman"  name="myform" onsubmit="return(Validation());" id="RegisterForm"  method="post">
						
               
                <div class="form-group">
                    <label for="userid" class="col-sm-3 control-label">Manager Id</label>
                    <div class="col-sm-9">
                        <form:input type="text" path="managerid" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
