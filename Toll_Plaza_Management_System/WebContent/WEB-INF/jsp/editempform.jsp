                ...
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#mynavbar" aria-expanded="false" aria-controls="navbar">
                            ...
                            <a href="Manager_login.jsp" class="navbar-brand">TollPlaza</a>
                        </div>
        ...
        <div class="container">
            <div class="row">
             		<div class="col-md-8 col-sm-12">
                        <h2 class="head-title">Edit Employee Page</h2>
                        <hr class="botm-line">
                        
						<form:form class="form-horizontal" role="form" action="/SimpleProjectLogin/editsaveemp"  name="myform" onsubmit="return(Validation());" id="RegisterForm"  method="post">
						
               
                <div class="form-group">
                    <label for="userid" class="col-sm-3 control-label">Employee Id</label>
                    <div class="col-sm-9">
                        <form:input type="text" path="employeeid" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <form:input type="text" path="tollid" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="info_id" class="col-sm-3 control-label">Info ID</label>
                    <div class="col-sm-9">
                        <form:input type="text" path="infoid" class="form-control" />
                    </div>
                </div>
                                 <!-- /.form-group -->
                 <!-- /.form-group -->
