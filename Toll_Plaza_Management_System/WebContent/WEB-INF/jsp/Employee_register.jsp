...
function Validation() {	
    var x;
    x = document.myform.employeeid.value;
        ...
        <div class="container">
            <div class="row">
             		<div class="col-md-8 col-sm-12">
                        <h2 class="head-title">Employee Register Page</h2>
                        <hr class="botm-line">
                        
						<form class="form-horizontal" role="form" action="Employee_save"  name="myform" onsubmit="return(Validation());" id="RegisterForm"  method="post">
						
               
                <div class="form-group">
                    <label for="employeeid" class="col-sm-3 control-label">Employee Id</label>
                    <div class="col-sm-9">
                        <input type="text" name="employeeid" id="employee_id" placeholder="Employee ID" class="form-control" autofocus>
                    </div>
                </div>
                <div class="form-group">
