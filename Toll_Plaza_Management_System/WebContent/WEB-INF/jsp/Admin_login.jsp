                    ...
                    <div class="col-md-12">
                        ...
                        <div class="collapse navbar-collapse navbar-right" id="mynavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="Toll_register">Add Toll</a></li>
                                <li><a href="Manager_register">Add Manager</a></li>
                                <li><a href="viewtoll">View Toll</a></li>
                                <li><a href="view_manager">View Manager</a></li>
                                <li><a href="#">View All Transaction</a></li>
